...
- [SNS Aggregator](#sns-aggregator)
  ...
  - [Deployment](#deployment)
    ...
    - [Step 3: Deployment Artifact](#step-3-deployment-artifact)
...
The Message Aggregator consists of Lambda Function, that executes a Python 3.7 script against an inbound trigger from any of the SQS Queues.  The Lambda Function then sends the JSON of the SQS record to the outbound SNS Topic.
...
| 02-sns-aggregator-receiver-stack.yml & 01-sns-aggregator-sender-stack.yml | CloudFormation templates to deploy relevant resouces. These are customized to match your environment, and zipped into the MessageAggArtifact.zip bundle |
| MessageAggArtifact.zip                                       | Zipped bundle of receiver and sender stacks for the CodePipeline to reference |
...
01-sns-aggregator-sender-stack.yml
02-sns-aggregator-receiver-stack.yml
...
As a best practice, we would recommend creating and managing your own deployment IAM Roles, with relevant trusts and abstract from dependencies on AWS controlled/deployed roles.
